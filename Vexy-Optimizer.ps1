...
$script:VexyVersion = '6.1.1-purple-switch-info'
...
$script:Pages = @{
    dashboard = @(
        ...
        @{Title='DIAGNOSTICS'; Desc='Read basic Windows and hardware information.'; Info='Reads the operating system, processor, graphics adapter and installed physical memory for display in the VEXY event log. It does not benchmark or change hardware.'; Icon='diagnostics'; Action='Diagnostics'; Kind='Action'; Risk='Normal'},
    ...
    about = @(
        ...
        @{Title='SAFETY MODEL'; Desc='See which system areas VEXY deliberately avoids.'; Info='VEXY does not disable Defender, Windows Recovery, Ctrl+Alt+Delete, Task Manager, security protections, or modify firmware/BIOS. Experimental means a reversible Windows trade-off, not destructive system modification.'; Icon='security'; Action='SafetyInfo'; Kind='Action'; Risk='Normal'}
    )
}
...
$script:PageTitles = @{
    ...
    tools=@('VEXY TOOLS','DIAGNOSTICS, STARTUP CONTROL AND WINDOWS RECOVERY.')
